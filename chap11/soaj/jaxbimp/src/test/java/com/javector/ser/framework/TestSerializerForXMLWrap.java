 ...
 */
public class TestSerializerForXMLWrap extends TestCase {
    boolean test;    // todo : remove once the test case is fixed

    public static final String NS_test = "http://javector.com/ser/adaptive/po";
    String xmlFile = "com/javector/ser/framework/SOAAdaptiveXMLWrap.xml";
    ...
    static URL[] url = new URL[]{Thread.currentThread().getContextClassLoader().getResource("com/javector/ser/adaptive/po/SOAAdaptiveWrapXMLTest.xsd")};
    ...
    public void testGetJava_PurchaseOrder() throws SoajException {
        if(!test) return;     // todo : remove once the test case is fixed
