...
//! <c>chap08</c><s>descriptor</s>
    ...
    URL wsdlURL = 
      new URL("http://"+hostVal+":"+portVal+"/chap08-descriptor-webxml-endpoint/my-pattern?wsdl");
    printWSDL(wsdlURL);
...
//! </example>  
    assertEquals("Hello: Java Programmer[appended by handler: ZipZapZang!]", result);
