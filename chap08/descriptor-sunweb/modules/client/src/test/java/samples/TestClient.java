...
public class TestClient extends TestCase {
  ...
  public void testEndpoint() throws Exception {
    ...
    URL wsdlURL = 
      new URL("http://"+hostVal+":"+portVal+"/my-context/MyHelloService?wsdl");
    printWSDL(wsdlURL);
    QName serviceQName = new QName("http://samples/", "MyHelloService");
    ...
    assertEquals("Hello: Java Programmer", result);
